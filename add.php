      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
              <li><a href="index.php">CSV Maker</a></li>
              <li class="active"><a href="add.php">CSV Editor</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
...
?>
                ...
                <div class="text-right">
                    <a href="#" id="addrow" class="btn btn-default"><i class="fa fa-plus"></i>Tambah Data</a>
                </div>
                <hr>
                <div>
                    <a href="#" id="cancel" class="btn btn-default"><i class="fa fa-undo"></i>Muat Ulang</a>
                    <a href="#" id="save" class="btn btn-primary"><i class="fa fa-save"></i>Simpan</a>
                </div>
                </form>
    ...
    $("#save").click(function(e) { 
        ...
        $.ajax({
            ...
            success: function(response) {
                makeMessage("<h4>" + response.responseText + "</h4>Data berhasil tersimpan!", "success", "message");
